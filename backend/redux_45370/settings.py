"""
Django settings for redux_45370 project.
...
WSGI_APPLICATION = 'redux_45370.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "redux_45370 API",
    "DESCRIPTION": "API documentation for redux_45370 App",
    "VERSION": "v1",
}
